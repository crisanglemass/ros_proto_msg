...
// double timestamp = 4;
inline void PublishInfo::clear_timestamp() {
  timestamp_ = 0;
}
inline double PublishInfo::_internal_timestamp() const {
  return timestamp_;
}
inline double PublishInfo::timestamp() const {
  // @@protoc_insertion_point(field_get:huizhang.sample.PublishInfo.timestamp)
  return _internal_timestamp();
}
inline void PublishInfo::_internal_set_timestamp(double value) {
  
  timestamp_ = value;
}
inline void PublishInfo::set_timestamp(double value) {
  _internal_set_timestamp(value);
  // @@protoc_insertion_point(field_set:huizhang.sample.PublishInfo.timestamp)
}
